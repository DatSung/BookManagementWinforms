namespace BookStore_DatNT
{
    partial class BookForm
    {
		...
		private void InitializeComponent()
		{
			...
			// groupBox2
			// 
			groupBox2.Controls.Add(cbbCategory);
			...
			groupBox2.Controls.Add(dtpReleaseDate);
			...
			groupBox2.Location = new Point(92, 124);
			groupBox2.Name = "groupBox2";
			groupBox2.Size = new Size(842, 922);
			...
			txtDescription.Size = new Size(466, 187);
			...
			// txtId
			// 
			txtId.Location = new Point(290, 76);
			txtId.Name = "txtId";
			...
			// button1
			// 
			button1.Location = new Point(603, 1082);
			...
			// button2
			// 
			button2.Location = new Point(784, 1082);
			...
			lblTitle.Text = "Add a book";
			// 
			// BookForm
			// 
			AutoScaleDimensions = new SizeF(13F, 32F);
			AutoScaleMode = AutoScaleMode.Font;
			ClientSize = new Size(1030, 1168);
